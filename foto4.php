...
// Query untuk mengambil materi keempat sesuai dengan kelas Fotografi
$sql = "SELECT * FROM materi WHERE Id_Kelas = '$id_kelas' LIMIT 1 OFFSET 3"; // Ambil baris keempat (indeks 3) untuk halaman foto4.php
...
<main>
    ...
    <section class="mulaiQuiz">
        <!-- Tombol Next yang mengarah ke halaman foto5.php -->
        <button class="next-button" onclick="window.location.href='foto5.php'">Next</button>
    </section>
</main>
</body>
</html>
