...
// Query untuk mengambil materi ketiga sesuai dengan kelas Fotografi
$sql = "SELECT * FROM materi WHERE Id_Kelas = '$id_kelas' LIMIT 1 OFFSET 2"; // Ambil baris ketiga (indeks 2) untuk halaman foto3.php
...
<main>
    ...
    <section class="mulaiQuiz">
        <!-- Tombol Next yang mengarah ke halaman foto4.php -->
        <button class="next-button" onclick="window.location.href='foto4.php'">Next</button>
    </section>
</main>
</body>
</html>
