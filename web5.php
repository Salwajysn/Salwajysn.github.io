...
// Di sini kita akan menggunakan Kls03 sebagai contoh
$id_kelas = "Kls03";

// Query untuk mengambil satu materi sesuai dengan kelas Kls03
$sql = "SELECT * FROM materi WHERE Id_Kelas = '$id_kelas' LIMIT 4, 1"; // Ambil baris pertama untuk halaman web5.php
...
<main>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('mulaiQuizButton').addEventListener('click', function() {
            window.location.href = 'quizWeb.php';
        });
    });
    </script>
